...
echo "auto-generated by afni_proc.py, Tue Oct 23 20:52:20 2018"
echo "(version 6.19, September 18, 2018)"
echo "execution started: `date`"

# execute via : 
#   tcsh -xef run_afni_04_retest.sh |& tee output.run_afni_04_retest.sh
...
3dcopy                                                                             \
    /scratch/psyc5171/dataset1/sub-04/ses-retest/anat/sub-04_ses-retest_T1w.nii.gz \
    $output_dir/sub-04_ses-retest_T1w

# ============================ auto block: tcat ============================
# apply 3dTcat to copy input dsets to results dir,
# while removing the first 2 TRs
3dTcat -prefix $output_dir/pb00.$subj.r01.tcat \
    /scratch/psyc5171/dataset1/sub-04/ses-retest/func/sub-04_ses-retest_task-fingerfootlips_bold.nii.gz'[2..$]'
...
# (new anat will be intermediate, stripped, sub-04_ses-retest_T1w_ns+orig)
align_epi_anat.py -anat2epi -anat sub-04_ses-retest_T1w+orig \
...
@auto_tlrc -base MNI_avg152T1+tlrc -input sub-04_ses-retest_T1w_ns+orig -no_ss

# store forward transformation matrix in a text file
cat_matvec sub-04_ses-retest_T1w_ns+tlrc::WARP_DATA -I > warp.anat.Xat.1D

# ================================= volreg =================================
# align each dset to base volume, align to anat, warp to tlrc space

# verify that we have a +tlrc warp dataset
if ( ! -f sub-04_ses-retest_T1w_ns+tlrc.HEAD ) then
    echo "** missing +tlrc warp dataset: sub-04_ses-retest_T1w_ns+tlrc.HEAD" 
    exit
endif
...
foreach run ( $runs )
    ...
    cat_matvec -ONELINE                                         \
               sub-04_ses-retest_T1w_ns+tlrc::WARP_DATA -I      \
               sub-04_ses-retest_T1w_al_junk_mat.aff12.1D -I    \
               mat.r$run.vr.aff12.1D > mat.r$run.warp.aff12.1D

    # apply catenated xform: volreg/epi2anat/tlrc
    3dAllineate -base sub-04_ses-retest_T1w_ns+tlrc             \
...
3dcopy sub-04_ses-retest_T1w_ns+tlrc anat_final.$subj
...
3dAllineate -source sub-04_ses-retest_T1w+orig                  \
...
3dresample -master full_mask.$subj+tlrc -input sub-04_ses-retest_T1w_ns+tlrc \
...
#
# afni_proc.py -subj_id 04-retest -script run_afni_04_retest.sh                                           \
#     -scr_overwrite -blocks tshift align tlrc volreg blur mask scale regress                             \
#     -copy_anat                                                                                          \
#     /scratch/psyc5171/dataset1/sub-04/ses-retest/anat/sub-04_ses-retest_T1w.nii.gz                      \
#     -dsets                                                                                              \
#     /scratch/psyc5171/dataset1/sub-04/ses-retest/func/sub-04_ses-retest_task-fingerfootlips_bold.nii.gz \
