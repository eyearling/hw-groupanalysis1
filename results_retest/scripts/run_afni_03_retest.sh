...
echo "auto-generated by afni_proc.py, Tue Oct 23 20:52:34 2018"
echo "(version 6.19, September 18, 2018)"
echo "execution started: `date`"

# execute via : 
#   tcsh -xef run_afni_03_retest.sh |& tee output.run_afni_03_retest.sh
...
3dcopy                                                                             \
    /scratch/psyc5171/dataset1/sub-03/ses-retest/anat/sub-03_ses-retest_T1w.nii.gz \
...
3dTcat -prefix $output_dir/pb00.$subj.r01.tcat \
    /scratch/psyc5171/dataset1/sub-03/ses-retest/func/sub-03_ses-retest_task-fingerfootlips_bold.nii.gz'[2..$]'
...
#
# afni_proc.py -subj_id 03-retest -script run_afni_03_retest.sh                                           \
#     -scr_overwrite -blocks tshift align tlrc volreg blur mask scale regress                             \
#     -copy_anat                                                                                          \
#     /scratch/psyc5171/dataset1/sub-03/ses-retest/anat/sub-03_ses-retest_T1w.nii.gz                      \
#     -dsets                                                                                              \
#     /scratch/psyc5171/dataset1/sub-03/ses-retest/func/sub-03_ses-retest_task-fingerfootlips_bold.nii.gz \
